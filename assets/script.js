function initengahan(){
  ...
  function tombol(){wallpaper.style="transform: scale(1);";Tombol.style="opacity:1;transform: scale(1);";if(fungsi==2){By.innerHTML="❤️"}}
  ...
  await swalst.fire({title: '' + katatambahan.innerHTML, timer: 2000, imageUrl: '' + stikerditolak.src,});
    ...
    audio.addEventListener('ended', function() {
        this.currentTime = 0; // Kembali ke awal audio
        this.play();          // Mulai memutar ulang audio
    }, false);